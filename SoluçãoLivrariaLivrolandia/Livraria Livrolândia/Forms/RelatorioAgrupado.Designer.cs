...
namespace Livraria_Livrolândia.Forms
{
    partial class RelatorioAgrupado
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "Relatorio_Agrupado";
            reportDataSource1.Value = this.lIVROBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Livraria_Livrolândia.Relatorios.RelatorioAgrupado.rdlc";
            ...
            this.Text = "Relatorio Agrupado";
            this.Load += new System.EventHandler(this.RelatorioAgrupado_Load);
